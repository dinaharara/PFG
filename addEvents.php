            ...
            <div id="page-inner">
                ...
                <form method="post">
                  ...
                  <div class="form-group">
                    ...
                    <input name="description" type="text" class="form-control" id="exampleInputPassword1" placeholder="Description" required>
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <input name="speaker" type="text" class="form-control" placeholder="speaker" required>
                  </div>
                  <div class="form-group">
                    <label for="validationServer01">Start time</label>
                    <input name="starttime" type="time" class="form-control" placeholder="starttime" required>
                  </div>
                  <div class="form-group">
                    <label for="validationServer01">End time</label>
                    <input name="endtime" type="time" class="form-control" placeholder="endtime" required>
                  </div>
                  <div class="form-group">
