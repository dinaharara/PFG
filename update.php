...
if(isset($_POST['submit'])){
  ...
  $sql="update `articles` set id=$id , name = '$name' , description = '$description' , link = '$link' where id=$id";
  $result = mysqli_query($con,$sql);
      if ($result) {
        $_SESSION['updateSuccess'] = true; // Set session variable for successful update
